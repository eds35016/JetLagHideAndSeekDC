...
server.listen(PORT, () => {
    console.log(`Team WebSocket server running on port ${PORT}`);
    console.log(`WebSocket endpoint: ws://localhost:${PORT}/ws/teams`);
    console.log(`REST API available at: http://localhost:${PORT}/api/teams/`);
